export default {
  ...
  admin: {
    ...
    apiConfig: {
      ...
      resendFromHint: "Standard funktioniert sofort ohne eigene Domain-Verifizierung (Resend-Sandbox). Eigene Domain unter resend.com/domains verifizieren, um von dort zu senden.",
