export default {
  ...
  pin: {
    ...
    viewHeading: "Note",
    title: "Title",
    titlePlaceholder: "e.g. Nice rest spot",
    descriptionOptional: "Description (optional)",
    descriptionPlaceholder: "e.g. Bench with a view, good place for a break",
    save: "Save",
    saving: "Saving...",
    cancel: "Cancel",
    by: "By",
    ...
    delete: "Delete",
    deleting: "Deleting...",
    confirmDelete: "Really delete this note?",
    loginRequired: "Please log in to drop a note.",
    errors: {
      noTitle: "Please enter a title.",
    },
  },
  ...
  admin: {
    ...
    pins: "Note pins",
    stravaConnectedCount: "Strava connected",
    emailsSent: "Emails sent",
    online: {
      label: "Online",
      minutesSuffix: "min",
      heading: "Active users",
      empty: "No one active right now.",
      justNow: "just now",
