export default {
  ...
  admin: {
    ...
    apiConfig: {
      ...
      resendFromHint: "The default works immediately with no domain verification (Resend's sandbox sender). Verify your own domain at resend.com/domains to send from it.",
